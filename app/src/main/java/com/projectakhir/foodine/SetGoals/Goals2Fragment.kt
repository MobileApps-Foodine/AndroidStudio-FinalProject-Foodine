...
import kotlinx.android.synthetic.main.activity_goals.view.*
import kotlinx.android.synthetic.main.activity_sign_in_up.*
import kotlinx.android.synthetic.main.activity_sign_in_up.nav_host_fragment
...
class Goals2Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        weightScale.setValueListener {
            ...
            setGoal.weight = String.format("%.1f", doubleType).toDouble()
        }
        ...
        heightScale.setValueListener {
            ...
            val doubleType = it.toDouble()
            setGoal.height = String.format("%.1f", doubleType).toDouble()
        }
        return view
    }
